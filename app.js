...
const slides=[
  ...
  {c:['LE OPZIONI','CI PERMETTONO','DI CAPIRE DOVE SONO','POSIZIONATI I SOLDI.'],a:[1,3]},
  ...
  {c:['PERCHÉ L’OI FA DA MAGNETE','IL PREZZO NON VIENE ATTIRATO','PERCHÉ L’OI È MAGICO.'],a:[0,1],size:S,v:'oi-magnet.png'},
  ...
  {c:['QUINDI IL GEX TRASFORMA L’IDEA ASTRATTA','DEL GAMMA IN UNA MISURA CONCRETA.','NON SOLO: “FRENANO”, MA QUANTO FRENANO.','NON SOLO: “SPINGONO”, MA QUANTO SPINGONO.'],a:[1,2,3],size:S},
  {c:['GAMMA = FRENO O ACCELERATORE.','GEX = QUANTO È FORTE','QUEL FRENO O QUELL’ACCELERATORE.'],a:[0,1,2],size:S},
